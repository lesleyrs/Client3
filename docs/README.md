...
## TODO
```
- GL1.1 issues: forced redraw_background every frame is causing some memleaks EG coins in bank while the interface is open, see if glTextureTriangle shadeShifts can be more accurate
