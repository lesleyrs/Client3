...
## TODO
```
- GL1.1 issues: forced redraw_background every frame is causing some memleaks EG coins in bank while the interface is open, client_load probably needs to be rewritten to keep redrawing.
