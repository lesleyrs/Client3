...
## TODO
```
GL1.1 issues: make texture shading more accurate, hardcoded vertex offsets in pix3d (+ 8 and + 11), needs to be different for model_draw_simple and other pix), pixfont wave/colors broken when drawing pixmaps?
