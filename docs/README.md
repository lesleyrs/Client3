...
- GL: see if gl_texture_triangle shadeShifts can be more accurate, running glTranslatef looks choppy? (not used rn), Z_FAR had to be increased to 4500 to match software? on area load screen turns black and doesn't draw the world
