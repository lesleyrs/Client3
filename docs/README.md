...
GL issues: some effects (teleport/levelup) appear too big/not transparent, hardcoded vertex offsets in pix3d (+ 8 and + 11), needs to be different for model_draw_simple and other pix), pixfont wave/colors broken
