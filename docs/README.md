...
## TODO
```
- GL 1.1 renderer based on https://github.com/2004Scape/Client2/compare/main...dennisdev:Client2:feature/webgl2
GL issues: lumbridge door looks weird, some effects (teleport/levelup) appear too big/not transparent, hardcoded vertex offsets in pix3d (+ 8 and + 11), needs to be different for model_draw_simple and other pix), pixfont wave/colors broken
